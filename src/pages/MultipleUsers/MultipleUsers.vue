              ...
              <div class="row">
                <div class="col-md-4 text-center">
                  ...
                  <q-btn
                    ...
                    color="red-10"
                    text-color="red-1"
                    label="New User Template"
                    @click="dialog = true"
                    :disable="!$can('create', 'Multiple Users')"
                  />
                </div>
                <div class="col-md-4">
                  <span
                  ...
                  <p class="text-subtitle2">
                    Please use the company name and available roles listed in the template only
                  </p>
                </div>
                <div class="col-md-4 text-center">
                  <span
...
export default {
  ...
  methods: {
    ...
    async onSubmit () {
      try {
        const res = await this.$axios.get('/import-users/getTemplate', {
          params: {
    ...
    async onUpload () {
      ...
      try {
        ...
        const res = await this.$axios.post('/import-users', data)
